...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(max_length=254,required= True, help_text='Required. Inform a valid email address.', label='Email ')
    ...
    class Meta:
        model = User
        fields = ('username', 'f_name', 'l_name', 'email', 'password1', 'password2','github_profile', 'reddit_profile', 'facebook_profile', 'linkedin_profile','image', )
