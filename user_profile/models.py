...
class Profile(models.Model):
    ...
    image = models.FileField(upload_to='profilepics/',  default='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqV9NdKL5sLeya9zSDAjA4_JbsaGrlEwPBay2SjtJn7mzMtjEK')
